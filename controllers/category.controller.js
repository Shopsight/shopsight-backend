...
const getAllCategories = async (req, res) => {
    try {
        const allCategories =
            "SELECT subCat.id, cat.name AS catName, subCat.name AS subCatName, subCat.id, imageLink FROM category AS cat RIGHT JOIN subCategory AS subCat ON cat.id = subCat.categoryId";
